...
const data: ServicePageData = {
  ...
  fees: [
    "Hyprr is paid on realised margin — what a catalogue line actually made after landed cost, marketplace fees, advertising and returns, once it has sold. Not on revenue, and not on the capital you deploy: no part of the fee is calculated from what you spend on inventory. That matters here more than in any other service, because a fee tied to purchase volume rewards recommending more buying, which is exactly the incentive this business should not have.",
    "The full mechanic, including how realised margin is calculated, is on the how-we-work page.",
  ],
  faqs: [
    {
